...
public interface WarehouseResource {
  ...
  /**
   * <p>
   * Returns a paginated, filtered list of active (non-archived) warehouse units.
   * All query parameters are optional; when multiple filters are provided they
  ...
  @GET
  @Produces("application/json")
  WarehouseSearchResult searchWarehouseUnits(@QueryParam("location") String location,
